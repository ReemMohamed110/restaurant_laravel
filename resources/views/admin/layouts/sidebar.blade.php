        ...
        <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="sidebar-left" data-simplebar style="height: 100%;">
                ...
                <ul class="nav sidebar-inner" id="sidebar-menu">
                    ...
                    <li class="">
                        <a class="sidenav-item-link" href="{{url('allUsers')}}">
                            <i class="mdi mdi-briefcase-account-outline"></i>
                            <span class="nav-text">all users</span>
                        </a>
                    </li>
                    <li class="">
                        <a class="sidenav-item-link" href="{{url('addCategory')}}">
                            <i class="mdi mdi-briefcase-account-outline"></i>
                            <span class="nav-text">add category</span>
                        </a>
                    </li>
                    <li class="">
                        <a class="sidenav-item-link" href="{{url('allCategories')}}">
                            <i class="mdi mdi-briefcase-account-outline"></i>
                    ...
                    <li class="">
                        <a class="sidenav-item-link" href="{{url('allItems')}}">
                            <i class="mdi mdi-briefcase-account-outline"></i>
                            <span class="nav-text">all item</span>
                        </a>
                    </li>
                    <li class="">
                        <a class="sidenav-item-link" href="{{url('addEmployee')}}">
                            <i class="mdi mdi-briefcase-account-outline"></i>
                            <span class="nav-text">add employee</span>
                        </a>
                    </li>
                    <li class="">
                        <a class="sidenav-item-link" href="{{url('addAdmin')}}">
                            <i class="mdi mdi-briefcase-account-outline"></i>
                    ...
                    <li class="">
                        <a class="sidenav-item-link" href="{{url('addPost')}}">
                            <i class="mdi mdi-briefcase-account-outline"></i>
                            <span class="nav-text">add post</span>
                        </a>
                    </li>
                    <li class="">
                        <a class="sidenav-item-link" href="{{url('allPosts')}}">
                            <i class="mdi mdi-briefcase-account-outline"></i>
                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="all" role="tabpanel"
                                            ...
                                            <div class="media media-sm bg-warning-10 p-4 mb-0">
                                                <div class="media-sm-wrapper">
                                                    <a href="user-profile.html">
                                                        <img src="{{ asset('admin/assets/images/user/user-sm-02.jpg') }}"
                                                            alt="User Image">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="media media-sm p-4 mb-0">
                                                <div class="media-sm-wrapper">
                                                    <a href="user-profile.html">
                                                        <img src="{{ asset('admin/assets/images/user/user-sm-03.jpg') }}"
                                                            alt="User Image">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <div class="tab-pane fade" id="message" role="tabpanel"
                                            ...
                                            <div class="media media-sm p-4 mb-0">
                                                <div class="media-sm-wrapper">
                                                    <a href="user-profile.html">
                                                        <img src="{{ asset('admin/assets/images/user/user-sm-01.jpg') }}"
                                                            alt="User Image">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <div class="media media-sm p-4 mb-0">
                                                <div class="media-sm-wrapper">
                                                    <a href="user-profile.html">
                                                        <img src="{{ asset('admin/assets/images/user/user-sm-04.jpg') }}"
                                                            alt="User Image">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                        ...
                        <li class="dropdown user-menu">
                            <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                                <img src="{{ asset('admin/assets/images/user/user-xs-01.jpg') }}"
                            ...
                            <div class="card-header">
                                ...
                                <div class="dropdown dropdown-chat-state">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right"
                                        ...
                                        <li>
                                            <a href="#" class="user-link">
                                                <img src="{{ asset('admin/assets/images/user/user-sm-05.jpg') }}"
                                                    alt="User Image">
